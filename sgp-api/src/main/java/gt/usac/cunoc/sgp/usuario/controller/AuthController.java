...
public class AuthController {
  ...
  public ResponseEntity<MessageResponse> requestRecovery(
  ...
  public ChallengeResponse requestTwoFactorEnable(
      Authentication authentication, @Valid @RequestBody TwoFactorRequest request) {
    return authService.requestTwoFactorChange(
        authentication.getName(), request.currentPassword(), OtpPurpose.ACTIVAR_2FA);
  }
  ...
  public MessageResponse confirmTwoFactorEnable(
      Authentication authentication, @Valid @RequestBody VerifyChallengeRequest request) {
    return authService.confirmTwoFactorChange(
        authentication.getName(), request.challengeId(), request.otp(), OtpPurpose.ACTIVAR_2FA);
  }
  ...
  public ChallengeResponse requestTwoFactorDisable(
      Authentication authentication, @Valid @RequestBody TwoFactorRequest request) {
    return authService.requestTwoFactorChange(
        authentication.getName(), request.currentPassword(), OtpPurpose.DESACTIVAR_2FA);
  }
  ...
  public MessageResponse confirmTwoFactorDisable(
      Authentication authentication, @Valid @RequestBody VerifyChallengeRequest request) {
    return authService.confirmTwoFactorChange(
        authentication.getName(), request.challengeId(), request.otp(), OtpPurpose.DESACTIVAR_2FA);
  }
  ...
  private <T> ResponseEntity<T> withRefreshCookie(T body, String rawRefreshToken) {
    if (rawRefreshToken == null) return ResponseEntity.ok(body);
